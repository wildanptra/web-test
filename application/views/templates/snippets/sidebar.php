...
<nav class="cat__menu-left">
    ...
    <div class="cat__menu-left__logo">
        <a href="<?php echo base_url().'dashboard'; ?>">
            <img src="<?=base_url('assets/front/common/img/logo-inverse.png');?>">
        </a>
    </div>
    <div class="cat__menu-left__inner">
        <ul class="cat__menu-left__list cat__menu-left__list--root">
          <?php echo sideBarMenu(JCfg('menu'),true); ?>
        </ul>
            </li>
            <li class="cat__menu-left__divider"><!-- --></li>
        </ul>
    <div class="ps__scrollbar-x-rail" style="left: 0px; bottom: 0px;"><div class="ps__scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__scrollbar-y-rail" style="top: 0px; height: 582px; right: 0px;"><div class="ps__scrollbar-y" tabindex="0" style="top: 0px; height: 267px;"></div></div></div>
</nav>
