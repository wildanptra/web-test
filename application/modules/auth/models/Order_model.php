...
class Order_model extends NoAuth_Controller {
    ...
    var $table = 'tb_order';
    var $column_order = array('id_order','tb_product.id_product','tb_order.qty','tb_order.price','tb_order.subtotal','tb_users.user_id','tb_order.tanggal_transaksi');
    var $order = array('id_order','tb_product.id_product','tb_order.qty','tb_order.price','tb_order.subtotal','tb_users.user_id','tb_order.tanggal_transaksi');

    public function getOrder()
    {
        $this->db->select('tb_order.*,tb_product.id_product,tb_product.name as name_product,tb_product.description as description_product,tb_product.price as price_product,tb_order.qty,tb_order.price,tb_order.subtotal,tb_users.user_id,tb_order.status_order,tb_order.tanggal_transaksi');
    ...
    public function _get_data_query()
    {
        ...
        if(isset($_POST['search']['value'])) {
            ...
            $this->db->or_like('tb_order.subtotal', $_POST['search']['value']);
